...
const RecentTransactions = () => {
  return (
    <div className='col-span-12 p-4 rounded-lg border border-stone-300 shadow'>
...
const TableRow = ({
    ...
    return (
        <tr className={order % 2 ? 'bg-stone-100 text-sm' : 'text-sm'}>
            ...
            <button className='hover:bg-stone-200 translate-colors grid place-content-center rounded text-sm size-8'>
                <FiMoreHorizontal />
            </button>
        </tr>
    )
